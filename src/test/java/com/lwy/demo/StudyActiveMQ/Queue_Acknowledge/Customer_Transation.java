package com.lwy.demo.StudyActiveMQ.Queue_Acknowledge;
 ...
 * 消息消费者 事务 签收
 */
public class Customer_Transation {
    //连接位置 根据主机ip地址  查看IP  ipconfig
    public static final String ACTIVEMQ_URL = "tcp://127.0.0.1:61616";
    public static final String QUEUE_NAME = "queue01_ak";
    public static void main(String[] args) throws Exception{
        ...
        //生产事务开启 只有commit  才会将消息变成已接收  事务 > 接收
